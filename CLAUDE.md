...
- The Railway GitHub App is installed on the CostaFot account (done 2026-08-15
  ...
  to main is verified working (~1 min from push to live). Railway builds on its
  own infra — GitHub Actions runs CI (`.github/workflows/ci.yml`: gradle build +
  tests) but does not gate or trigger deploys; a red CI run won't stop Railway.
